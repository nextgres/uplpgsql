 ...
 * development tree this code was forked from.  Each name below was introduced
 * in PostgreSQL 19; on 18 and earlier they are provided as equivalents.  This
...
#endif
/* Bare "varlena" type alias (struct varlena has always existed). */
